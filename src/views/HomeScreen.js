          ...
          <View style={styles.content}>
            ...
            >
              ...
              <SkeletonComponent Data={state.userName} isButton>
                <ButtonsComponent color="green" isFollow onPress={handleAd}>
            ...
            {/* Image Content */}
            <RowComponent minHeight={appInfo.widthWindows * 0.4} maxHeight={appInfo.widthWindows * 0.7} style={{
              marginVertical: "3%",
            }}>
              <ImagesComponent Data={state.images} />
            </RowComponent>
            <RowComponent height={appInfo.widthWindows / 10}>
